...
<script src="get_invoice_ajax.js" type="text/javascript"></script>
...
<tr><td colspan="1">Search (By DOL-Invoice Printing System Coustomer's ID Number or Coustomer's Name or Invoice number ).
